// Clé de stockage pour la nuit en cours et limite des nuits jouables.
const NIGHT_KEY = "currentNight", MAX_NIGHT = 3;
// Son utilisé pour faire entendre les pas de Springtrap.
const FOOTSTEP_PATH = "Assets/sounds/FNAF Footsteps - Gaming Sound Effect (HD) - Communist Sound Effects (1080p).mp4";
// Durée avant que Springtrap n'attaque en fonction de la nuit.
...
function playDirectionalFootsteps(side) {
	...
	const audio = new Audio(FOOTSTEP_PATH);
